            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    <form action='search.php' method='post' class="searchbar">
                        <input class="searchbar" type="search" name="search" placeholder="Search here for offers" aria-label="Search">
                        <input type="submit" name="searching" class="nav-item nav-link" value="Search">
                    </form>
