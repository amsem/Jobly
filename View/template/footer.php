<footer class="footer ourfooter">
    <div class="content has-text-centered">
      <div class="columns">
        <div class="column column1 is-6-desktop ml-3 has-text-white">
          <h2 class="title has-text-white">Find us on social media</h2>
          <p class="paragraph ml-2">
            Even if a website or a certian product delivers the best quality of
            work and is up to oyur standards, it still makes a difference
            meeting the team behind the whole thing. So join us ! And let’s live
    ...
    ></script>
    <script
      src="https://cdnjs.cloudflare.com/ajax/libs/gsap/2.1.2/plugins/CSSPlugin.min.js"
