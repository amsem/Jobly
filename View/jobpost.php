...
<div class="postjob">
  ...
  <div class="mb-3">
    <label for="exampleFormControlInput1" class="form-label">paie</label>
  ...
  <div class="mb-3">
    ...
    <input  type="text" class="form-control" id="exampleFormControlInput1" placeholder="Ex:Tizi-Ouzou">
  </div>  
